...
//Need way to get the messages, then need a way to output the messages
//need objects for input and objects for output
    //these are worker objects
//messages should be able to come from anywhere (keyboard, objects that have array of strings, 
//variation comes from the ways of getting messages
//more variation comes from ways of outputting messages
//similar to Copier b/c multiple components are needed

//need 2 forms of input and 2 forms of output, a service class that manages the classes
//remember best practices: validate methods, declare methods final
